...
df,df2= getdata('API_19_DS2_en_csv_v2_4700503.csv','SP.POP.GROW') # Extracting data from file 
...
# Bar chart
df, df2 = getdata('API_19_DS2_en_csv_v2_4700503.csv','SP.POP.TOTL')
...
df, df2 = getdata('API_19_DS2_en_csv_v2_4700503.csv','EN.ATM.NOXE.KT.CE')
df2.dropna()
...
plt.title("Nitruos Oxide emissions") # This function is for showing title of data
plt.show()
...
df, df2 = getdata('API_19_DS2_en_csv_v2_4700503.csv','AG.LND.FRST.K2')
